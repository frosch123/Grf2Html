...
type
   ...
   public
      ...
      procedure printHtml(path: string; const settings: TGrf2HtmlSettings);
 ...
 *)
procedure TNewGrfFile.printHtml(path: string; const settings: TGrf2HtmlSettings);
var
   t, t2                                : textFile;
...
begin
   ...
   for i := 0 to fSprites.count - 1 do
   begin
      if i * 100 div fSprites.count <> (i - 1) * 100 div fSprites.count then write(#13'Generating html', (i * 100 div fSprites.count): 3, '%');
