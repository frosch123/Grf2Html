...
begin
   ...
   begin
      ...
      begin
         writeln(t, '<tr><td>0x', intToHex(fFinalLangs[i], 2), getLanguageName(a8, fFinalLangs[i]), '</td><td>', formatTextPrintable(fFinalNames[i], true), '</td></tr>');
      end;
